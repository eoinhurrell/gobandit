// Package main provides the control plane web UI server
package main
...
func main() {
	...
	go func() {
		log.Printf("Control Plane web UI server starting on port 8081")
	...
	log.Println("Control plane server exited")
}
